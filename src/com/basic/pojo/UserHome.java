...
// Generated 2016-6-12 11:03:47 by Hibernate Tools 3.4.0.CR1
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) sessionFactory
					.getCurrentSession().createCriteria("com.basic.pojo.User")
