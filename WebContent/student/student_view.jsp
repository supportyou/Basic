					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" action="" method="post" name="myFormView" id="myFormView">
							<div class="form-group">
								...
								<div class="col-sm-5 form-control-static">${student.userName}</div>
							</div>
							<div class="form-group">
								<label for="sex" class="col-sm-3 control-label">Sex:</label>
								<div class="col-sm-5 form-control-static">${student.sex}</div>
							</div>
							<div class="form-group">
								<label for="birthday" class="col-sm-3 control-label">Birthday:</label>
								<div class="col-sm-5 form-control-static">${student.birthday}</div>
							</div>	
							<div class="form-group">
								<label for="degree" class="col-sm-3 control-label">Degree:</label>
								<div class="col-sm-5 form-control-static">${student.degree}</div>
							</div>	
							<div class="form-group">
								<label for="interest" class="col-sm-3 control-label">Interest:</label>
								<div class="col-sm-5 form-control-static">${student.interest}</div>
							</div>
							<div class="form-group">    
								<label for="remark" class="col-sm-3 control-label">Remark:</label>
								<% //request.setAttribute("vEnter", "\n"); %>
								<c:set var="vEnter" value="<%=\"\n\"%>" />
								<div class="col-sm-5 form-control-static" id="remark">${fn:replace(student.remark,vEnter,'<br>')}</div>
							</div>
							<div class="form-group">
								<label for="nonActive" class="col-sm-3 control-label">Non-Active:</label>
								<div class="col-sm-5 form-control-static">${student.nonActive}</div>
							</div>
   						</form>
					</div><!--/.panel-body-->
				</div><!--/.panel-->
